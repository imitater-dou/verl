...
`docker/Dockerfile.uv.cu130` for the cu13.0 backends the same way; trtllm stays
deferred. For the full story — the launch flow, the baked-cache mechanics, and
re-locking — see **"Install with uv"** in
